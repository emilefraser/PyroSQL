CREATE OR ALTER PROCEDURE #sp_job_list @JobNamePart AS SYSNAME = '', @SetJobStatus SMALLINT = -1
as  
BEGIN
...
SELECT 'msdb.dbo.sp_update_job @job_name=''' + job_cte.JobName + '''' + @sqlstatus_post
FROM job_cte
ORDER BY 1
...
EXEC #sp_job_list @JobNamePart = 'AggFact', @SetJobStatus = 0
GO
