USE master;
GO
IF OBJECT_ID('[dbo].[sp_GetDDLaV2]') IS NOT NULL 
  DROP PROCEDURE [dbo].[sp_GetDDLaV2] 
GO
--#################################################################################################
...
CREATE PROCEDURE [dbo].[sp_GetDDLaV2]
  @TBL                VARCHAR(255)
AS
BEGIN
  SET NOCOUNT ON
...
--#################################################################################################
--Mark as a system object
EXECUTE sp_ms_marksystemobject 'sp_GetDDLaV2'
GRANT EXECUTE ON dbo.sp_GetDDLaV2 TO PUBLIC;
--#################################################################################################
GO