...
CREATE PROCEDURE [DMOD].[sp_CreateHubTableInVirtualDC]
	@HubID INT
...
====================================================================================================*/
	...
	(
		SELECT TOP 1 
			   [sc].[SchemaID]
		FROM 
			[DC].[Schema] AS [sc] --TODO Update to read from DMOD.Schema_VirtualDC
		WHERE
	...
	BEGIN
		INSERT INTO [DMOD].[Schema] --TODO VirtualDC
		(
			   [SchemaName]
			 , [DatabaseID]
			 , [DBSchemaID]
	...
	*/
	...
	INSERT INTO [DMOD].[FieldRelation] ([SourceFieldID], [TargetFieldID], [FieldRelationTypeID], [CreatedDT], [IsActive])
	SELECT DISTINCT
