...
/*
	...
	How? 
		...
		EXEC DMOD.[sp_execute_AllLoads] @Today, @IsInitialLoad, @IsTestLoad, @DatabaseEnvironmentType
*/

CREATE      PROCEDURE [DMOD].[sp_execute_AllLoads]
	@Today VARCHAR(100), @IsInitialLoad BIT, @IsTestLoad BIT, @DatabaseEnvironmentType VARCHAR(20)
AS
