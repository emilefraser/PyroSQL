...
select 'Table below Brings back Hubs that do not have a load config for itself '
...
select 'Table below Brings back satellites that do not have a load config for itself'
...
select 'Table below Brings back Links that do not have a load config for itself '
