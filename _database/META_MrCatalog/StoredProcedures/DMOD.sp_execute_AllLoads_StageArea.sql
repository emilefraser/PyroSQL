...
AND Target_DEName  LIKE '%DV_Stock_D365_LVD%'
--AND Target_DEName NOT LIKE '%SalesTrail%'
--AND Target_DEName NOT LIKE '%DV_StockTransaction%'
--AND Target_DEName NOT LIKE '%DV_ContainerType%'
...
BEGIN  
			...
			BEGIN
				...
				IF (@LoadClassification = 'FullLoad' OR @IsInitialLoad = 1)
				BEGIN
