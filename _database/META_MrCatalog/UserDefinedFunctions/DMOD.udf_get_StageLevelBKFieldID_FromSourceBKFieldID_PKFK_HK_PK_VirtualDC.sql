...
CREATE FUNCTION [DMOD].[udf_get_StageLevelBKFieldID_FromSourceBKFieldID_PKFK_HK_PK_VirtualDC]
(
...
BEGIN
    ...
    DECLARE @Result varchar(50),
		...
		DECLARE @SourceFieldID int = 747519
				--, @VelocityType int = 2
	...
	AS
		...
		where SourceFieldID = @SourceFieldID
			...
			AND cte.ParentFieldName like 'HK%' 
