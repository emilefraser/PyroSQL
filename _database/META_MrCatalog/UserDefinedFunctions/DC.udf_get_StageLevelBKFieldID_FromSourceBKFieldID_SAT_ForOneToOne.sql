...
/*
    ...
    SELECT * FROM DataManager.DC.vw_DCDataLineage WHEre sourcefieldid = '1002375'
    SELECT * FROM DataManager.DC.vw_DCDataLineage WHEre sourcefieldid   = '1319344'

	select DC.[udf_get_StageLevelBKFieldID_FromSourceBKFieldID_SAT_ForOneToOne](1002375, 1)

*/

CREATE FUNCTION [DC].[udf_get_StageLevelBKFieldID_FromSourceBKFieldID_SAT_ForOneToOne]
(
