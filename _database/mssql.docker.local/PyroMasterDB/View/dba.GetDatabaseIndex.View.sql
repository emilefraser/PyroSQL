...
GO
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dba].[GetDatabaseIndex]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW [dba].[GetDatabaseIndex] 
AS
SELECT 
