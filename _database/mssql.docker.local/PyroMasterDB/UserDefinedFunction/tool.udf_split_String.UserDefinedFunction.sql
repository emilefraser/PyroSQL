...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[tool].[udf_split_String]') AND type in (N'FN', N'IF', N'TF', N'FS', N'FT'))
BEGIN
...
--*/
CREATE    FUNCTION [tool].[udf_split_String] (
