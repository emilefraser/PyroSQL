...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[internal].[GetSqlVarInfo]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [internal].[GetSqlVarInfo] AS' 
END
GO
...
-- be returend as NULL.
-- =======================================================================
ALTER   PROCEDURE [internal].[GetSqlVarInfo]
