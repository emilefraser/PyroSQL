...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[template].[StoredProcedure_Template]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [template].[StoredProcedure_Template] AS' 
END
GO
-- ======================================================
-- Author:		Emile Fraser
...
*/
-- ======================================================
ALTER   PROCEDURE [template].[StoredProcedure_Template]
	@Param1 INT
,	@Param2 INT = 0
,	@Param3 INT OUTPUT
AS
