...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[tool].[refresh_views]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [tool].[refresh_views] AS' 
END
GO
...
*/    
ALTER   PROCEDURE [tool].[refresh_views]
