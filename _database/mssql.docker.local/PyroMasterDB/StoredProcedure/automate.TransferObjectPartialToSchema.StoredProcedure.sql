...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[automate].[TransferObjectPartialToSchema]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [automate].[TransferObjectPartialToSchema] AS' 
END
GO
/*
...
*/
ALTER     PROCEDURE [automate].[TransferObjectPartialToSchema]
