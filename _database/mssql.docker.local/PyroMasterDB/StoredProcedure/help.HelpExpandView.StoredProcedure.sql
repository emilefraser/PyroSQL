...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[help].[HelpExpandView]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [help].[HelpExpandView] AS' 
END
GO
ALTER PROCEDURE [help].[HelpExpandView] (
