...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[string].[udf_get_PresentationView_CreateOrAlter_Statement]') AND type in (N'FN', N'IF', N'TF', N'FS', N'FT'))
BEGIN
