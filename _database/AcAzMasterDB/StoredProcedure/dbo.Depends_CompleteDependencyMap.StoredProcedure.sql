...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Depends_CompleteDependencyMap]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dbo].[Depends_CompleteDependencyMap] AS' 
END
GO
/*
	EXEC dbo.Depends_CompleteDependencyMap
*/
ALTER   PROCEDURE [dbo].[Depends_CompleteDependencyMap]
AS
BEGIN
