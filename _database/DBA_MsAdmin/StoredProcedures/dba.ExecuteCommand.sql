...
AS
    BEGIN
        ...
        SET @StartTimeSec = CONVERT(DATETIME, CONVERT(NVARCHAR, @StartTime, 113), 113);
        SET @StartMessage = 'Date and time: ' + CONVERT(NVARCHAR, @StartTimeSec, 113);
        ...
        ----------------------------------------------------------------------------------------------------
        SET @EndTime = GETDATE();
        SET @EndTimeSec = CONVERT(DATETIME, CONVERT(VARCHAR, @EndTime, 113), 113);
		...
		SET @EndMessage = 'Date and time: ' + CONVERT(NVARCHAR, @EndTimeSec, 120) + @sql_crlf + ' ';
        RAISERROR(@EndMessage, 10, 1) WITH NOWAIT;
