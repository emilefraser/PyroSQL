...
/*
	...
	EXEC STORE.sp_Update_StorageStats_Database @BatchID
*/
CREATE   PROCEDURE [STORE].[sp_Update_StorageStats_Database]
	@BatchID INT
AS
BEGIN
	
	-- If the table for Storage tracking doesnt exists for so
	IF OBJECT_ID('STORE.StorageStats_Database', 'U') IS NULL
	BEGIN 
