...
/*
	...
	EXEC STORE.sp_Update_StorageStats_Object @BatchID
*/
CREATE       PROCEDURE [STORE].[sp_Update_StorageStats_Object]
	@BatchID INT = NULL
AS
BEGIN
	...
	IF OBJECT_ID('STORE.StorageStats_Object', 'U') IS NULL
	BEGIN 

		CREATE TABLE STORE.[StorageStats_Object](
	...
	BEGIN 
		...
		set @sql_statement = '
		INSERT INTO STORE.StorageStats_Object
		(
				[BatchID]
			  ,	[object_id]
			  ,	[object_type]
