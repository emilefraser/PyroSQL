...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[adf].[Monitoring_Test]') AND type in (N'U'))
BEGIN
CREATE TABLE [adf].[Monitoring_Test](
	[Montoring_TestId] [int] IDENTITY(1,1) NOT NULL,
	...
	[ObjectType] [varchar](30) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
