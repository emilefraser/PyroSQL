...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[adf].[GetSapEntityColumnList_SOURCE]') AND type in (N'FN', N'IF', N'TF', N'FS', N'FT'))
BEGIN
execute dbo.sp_executesql @statement = N'/*
	...
	Test1: SELECT [adf].[GetSapEntityColumnList_SOURCE]( ''T000'', ''E'')

*/
CREATE          FUNCTION [adf].[GetSapEntityColumnList_SOURCE] (
...
BEGIN
	...
	SELECT @ColumnList += 
		CHAR(9) +
		[adf].[GetQuotedObject](@SapEntityName, 1) + ''.'' + [adf].[GetQuotedObject](FIELDNAME, 1) +
