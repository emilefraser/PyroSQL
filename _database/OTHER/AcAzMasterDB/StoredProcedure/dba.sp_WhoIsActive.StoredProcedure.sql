...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dba].[sp_WhoIsActive]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dba].[sp_WhoIsActive] AS' 
END
GO
...
License: 
	...
	written consent.
*********************************************************************************************/
ALTER   PROCEDURE [dba].[sp_WhoIsActive]
(
--~
