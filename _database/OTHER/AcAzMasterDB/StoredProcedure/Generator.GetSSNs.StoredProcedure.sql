...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Generator].[GetSSNs]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [Generator].[GetSSNs] AS' 
END
GO
ALTER   PROCEDURE [Generator].[GetSSNs]
	@Count AS BIGINT,
