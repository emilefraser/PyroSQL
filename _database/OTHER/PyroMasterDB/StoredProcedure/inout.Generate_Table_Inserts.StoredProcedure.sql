...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[inout].[Generate_Table_Inserts]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [inout].[Generate_Table_Inserts] AS' 
END
GO
/*                                       
...
*/
ALTER PROCEDURE [inout].[Generate_Table_Inserts]
(
