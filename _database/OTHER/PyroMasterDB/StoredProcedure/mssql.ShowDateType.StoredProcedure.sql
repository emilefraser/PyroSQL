...
-- mon types are nondeterministic conversions, metaent on language setting
...
-- nondeterministic means language setting metaent such as Mar/Mär/mars/márc
...
-- Month sequence generate - sequential numbers / dates
...
-- SQL dateformat with language metaency
