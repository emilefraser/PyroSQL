...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dba].[stpSecurity_Checklist]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dba].[stpSecurity_Checklist] AS' 
END
GO
...
ALTER PROCEDURE [dba].[stpSecurity_Checklist] (
