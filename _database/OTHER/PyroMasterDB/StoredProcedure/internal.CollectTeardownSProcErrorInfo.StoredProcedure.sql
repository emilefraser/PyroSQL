...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[internal].[CollectTeardownSProcErrorInfo]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [internal].[CollectTeardownSProcErrorInfo] AS' 
END
GO
...
-- Return code: 1
-- =======================================================================
ALTER   PROCEDURE [internal].[CollectTeardownSProcErrorInfo]
