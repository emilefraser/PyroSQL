...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[help].[Cheat]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [help].[Cheat] AS' 
END
GO


ALTER     PROCEDURE [help].[Cheat]
AS 
BEGIN
