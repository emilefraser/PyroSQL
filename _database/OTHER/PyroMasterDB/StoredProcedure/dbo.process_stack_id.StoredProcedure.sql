...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[process_stack_id]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dbo].[process_stack_id] AS' 
END
GO
 ...
 */
ALTER   PROCEDURE [dbo].[process_stack_id] 
	@stack_id as int 
