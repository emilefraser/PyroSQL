...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[tool].[obj_name]') AND type in (N'FN', N'IF', N'TF', N'FS', N'FT'))
BEGIN
...
*/
CREATE   FUNCTION [tool].[obj_name]( @fullObj_name varchar(255) ) 
RETURNS varchar(255) 
AS
BEGIN
