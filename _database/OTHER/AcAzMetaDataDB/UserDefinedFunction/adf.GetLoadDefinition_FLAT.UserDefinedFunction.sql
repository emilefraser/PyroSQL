...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[adf].[GetLoadDefinition_FLAT]') AND type in (N'FN', N'IF', N'TF', N'FS', N'FT'))
BEGIN
...
/*
	...
	Date: 2020-11-01
	Description: Gets the Load Definition for ADF Incremental API Load with ID
...
*/
CREATE       FUNCTION [adf].[GetLoadDefinition_FLAT] (
	@LoadConfigID			INT		
