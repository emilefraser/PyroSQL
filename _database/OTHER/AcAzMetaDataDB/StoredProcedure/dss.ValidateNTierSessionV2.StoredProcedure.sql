...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dss].[ValidateNTierSessionV2]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dss].[ValidateNTierSessionV2] AS' 
END
GO
-- TODO: Remove this SP after SU02-2013
ALTER PROCEDURE [dss].[ValidateNTierSessionV2]
