...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[util].[refresh_views]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [util].[refresh_views] AS' 
END
GO
...
*/    
ALTER   PROCEDURE [util].[refresh_views]
