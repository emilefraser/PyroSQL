...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[internal].[CollectTempTablesSchema]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [internal].[CollectTempTablesSchema] AS' 
END
GO
...
-- =======================================================================
ALTER   PROCEDURE [internal].[CollectTempTablesSchema]
AS
BEGIN
