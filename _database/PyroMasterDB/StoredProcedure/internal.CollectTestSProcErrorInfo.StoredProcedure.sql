...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[internal].[CollectTestSProcErrorInfo]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [internal].[CollectTestSProcErrorInfo] AS' 
END
GO
...
-- =======================================================================
ALTER   PROCEDURE [internal].[CollectTestSProcErrorInfo]
