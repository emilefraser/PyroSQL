...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[internal].[CollectSetupSProcErrorInfo]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [internal].[CollectSetupSProcErrorInfo] AS' 
END
GO
...
-- =======================================================================
ALTER   PROCEDURE [internal].[CollectSetupSProcErrorInfo]
