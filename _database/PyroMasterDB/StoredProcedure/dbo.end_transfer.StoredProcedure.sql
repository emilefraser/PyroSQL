...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[end_transfer]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dbo].[end_transfer] AS' 
END
GO
...
print @transfer_id 
*/
ALTER   PROCEDURE [dbo].[end_transfer]
	@transfer_id int 
