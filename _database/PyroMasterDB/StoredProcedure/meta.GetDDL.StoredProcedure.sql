...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[meta].[GetDDL]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [meta].[GetDDL] AS' 
END
GO


ALTER    PROCEDURE [meta].[GetDDL]
  @TBL                VARCHAR(255),
