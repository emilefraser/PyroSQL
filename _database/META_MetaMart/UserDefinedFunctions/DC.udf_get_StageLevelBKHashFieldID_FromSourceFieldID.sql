...
CREATE FUNCTION [DC].[udf_get_StageLevelBKHashFieldID_FromSourceFieldID]
(
...
BEGIN
	...
	AS
		...
		WHERE	cte.ParentDBName like 'DEV_Stage%' --TODO: Replace this with switch fields when they get introduced into the DC (hard coded to DB name for now)
