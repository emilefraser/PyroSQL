...
HOW?
	SELECT * FROM DMOD.vw_LoadConfig WHERE Target_DEName LIKE '%GoodsReceiptLine%'
...
BEGIN
	...
	DECLARE @LinkTable TABLE (ChildHubID INT, ChildHubName VARCHAR(255), PKFKLinkID INT, PKFKLinkName VARCHAR(255),
									ParentHubID INT, ParentHubName VARCHAR(255), FieldSortOrder INT, LinkIncrementer INT, TableAliasNumber INT, 
	...
	INSERT INTO @LinkTable  (ChildHubID, ChildHubName , PKFKLinkID , PKFKLinkName ,
									ParentHubID,  ParentHubName, FieldSortOrder, LinkIncrementer, TableAliasNumber , 
