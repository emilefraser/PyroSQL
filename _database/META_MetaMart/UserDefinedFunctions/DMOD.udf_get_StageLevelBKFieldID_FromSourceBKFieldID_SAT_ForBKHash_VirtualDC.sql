...
CREATE FUNCTION [DMOD].[udf_get_StageLevelBKFieldID_FromSourceBKFieldID_SAT_ForBKHash_VirtualDC]
(
...
--		/*
		...
		--DECLARE @SourceFieldID int = 163472
		--		, @VelocityType int = 2
	...
	AS
		...
		where ParentFieldName like 'BKHash%'
