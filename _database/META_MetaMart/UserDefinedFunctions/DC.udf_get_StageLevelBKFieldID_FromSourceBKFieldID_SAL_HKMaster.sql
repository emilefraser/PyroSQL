...
CREATE FUNCTION [DC].[udf_get_StageLevelBKFieldID_FromSourceBKFieldID_SAL_HKMaster]
(
...
BEGIN
	...
	AS
		...
		where SourceFieldID = @SourceFieldID
			...
			AND cte.TargetDataEntityName like '%_SAL' 
			AND cte.ParentFieldName like 'HK_Master%' 
