...
CREATE FUNCTION [DC].[udf_get_StageLevelBKDataEntityID_FromSourceBKFieldID]
(
...
BEGIN
	...
	INSERT INTO @DataLineage(SourceFieldID, SourceDataEntityName, SourceDBName, ParentFieldID, TargetDataEntityName, TargetDataEntityID, ParentDBName)
	...
	AS
		...
		SELECT	@StageLevelFieldID = TargetDataEntityID
