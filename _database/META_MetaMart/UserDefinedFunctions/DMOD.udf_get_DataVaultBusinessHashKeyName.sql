...
-- select [dmod].[udf_get_DataVaultBusinessHashKeyName] (3807)
	...
	SELECT TOP 5 * FROM DC.DataEntity WHERE DataEntityName LIKE 'HUB_%'
	SELECT TOP 500 * FROM DC.DataEntity WHERE DataEntityName LIKE '%Container%' AND DataEntityName LIKE '%KEYS%'
	S:58804 58805 T:58808
