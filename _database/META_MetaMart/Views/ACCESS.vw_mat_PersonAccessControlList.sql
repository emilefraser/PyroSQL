...
AS
SELECT        PACL.PersonAccessControlListID, 
			  PACL.OrgChartPositionID, 
			  PACL.PersonNonEmployeeID, 
			  CASE
				WHEN PACL.OrgChartPositionID IS NULL
				THEN PACL.PersonNonEmployeeID
				ELSE PACL.OrgChartPositionID
			  END AS [EmployeeOrNonEmployeeID],
			  PACL.CreatedDT, 
			  PACL.UpdatedDT, 
			  PACL.IsActive,
			  PNE.SupplierCompany, 
			  ...
			  PNE.Code, 
			  OCP.PositionCode, 
			  OCP.PositionDescription, 
			  OCP.ReportsToOrgChartPositionID, 
			  OCP.IsTopNode,
			  OCP.CompanyID, 
			  PE.PersonEmployeeID, 
			  PE.EmployeeNo, 
			  PE.PersonEmployeeCode, 
			  P.PersonID, 
			  P.FirstName, 
			  P.Surname, 
			  P.DomainAccountName,
