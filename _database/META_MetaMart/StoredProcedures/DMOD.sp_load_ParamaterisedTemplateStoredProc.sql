...
--Stored Proc Management
    ...
    DECLARE @LoadEntity_NonClusteredIndexName VARCHAR(150)  = QUOTENAME('ncidx_' + PARSENAME(@StageAreaSchemaName,1)  + '_' + PARSENAME(@StageAreaTableName,1))
		...
		DECLARE @DataVaultEntityType VARCHAR(20) = (SELECT DataEntityTypeCode FROM DMOD.vw_LoadType WHERE LoadTypeID = 47)
