...
SELECT DatabaseID FROM DC.[Database] WHERE DatabaseName = 'DEV_StageArea'
SELECT DatabaseID FROM DC.[Database] WHERE DatabaseName = 'DEV_DataVault'

select	*
from	DC.[Database]

EXEC [DC].[sp_create_TranslateModelToDC] 6, 8



select * from dc.dataentity where dataentityid = '4187'
*/
...
CREATE PROCEDURE [DC].[sp_create_TranslateModelToDC]-- 8, 9
