...
/*
	...
	How? 
		...
		EXEC DataManager.DMOD.[sp_generate_All_DynamicLoadTemplates_Vault] @Author, 'PROD', 1

		DECLARE @Author VARCHAR(100) =  'FS'
		EXEC DataManager.DMOD.[sp_generate_All_DynamicLoadTemplates_Vault] @Author, 'DEV', 1


		DELETE FROM DMOD.LoadConfig where LoadConfigID in (833, 834)
...
WHERE 1=1
	...
	AND lc.LoadConfigID BETWEEN 835	 AND 837
			...
			DECLARE @db sysname = 'DEV_DataVault'--= N'DEV_StageArea'; --TODO: Make this dynamic with parameters 
