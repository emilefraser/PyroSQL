...
CREATE PROCEDURE [APP].[sp_CRUD_DMOD_Load_Config_Internal](
...
BEGIN
	...
	IF @TransactionAction = 'Update'
		--BEGIN
		--	IF @LoadConfigID IS NULL --means a satellite name exists but with no load
		--		BEGIN
...
/****** Object:  StoredProcedure [APP].[sp_CRUD_Employee]    Script Date: 2019/12/19 2:22:31 PM ******/
SET ANSI_NULLS ON
