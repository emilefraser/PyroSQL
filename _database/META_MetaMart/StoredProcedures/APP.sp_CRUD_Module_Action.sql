...
SET @PrimaryKeyID = (SELECT ModuleActionID FROM  APP.ModuleAction WHERE ActionCode = @ActionCode AND ActionDescription = @ActionDescription AND ModuleID = @ModuleID)
...
Update APP.ModuleAction
Set
IsActive = 0 where ModuleActionID = @ModuleActionID
SET @PrimaryKeyID = @ModuleActionID
