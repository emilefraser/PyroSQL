IF OBJECT_ID('[dbo].[StripAlphaCustom_ITVF]') IS NOT NULL 
DROP  FUNCTION  [dbo].[StripAlphaCustom_ITVF] 
GO
--#################################################################################################
...
--#################################################################################################
CREATE FUNCTION dbo.StripAlphaCustom_ITVF(@OriginalText NVARCHAR(4000))
