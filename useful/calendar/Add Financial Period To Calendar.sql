	/*
	CREATE PROCEDURE dimension.AlterDateDimensionWithFinancialPeriod
  AS
*/
/*
...
*/
  ...
  DECLARE 
	...
	*****************************************/
	...
	SET @default_value		=  'CONVERT(VARCHAR(10), FORMAT([CalendarDate], ''MMMM'')'
	...
	SET @column_name		= N'DayOfWeekNameAbbreviation'
	SET @default_value		=  'CONVERT(VARCHAR(3), FORMAT([CalendarDate], ''MMM'')'
	...
	SET @default_value		= 'CONVERT(TINYINT,	FORMAT(DATEDIFF(d, DATEADD(qq, DATEDIFF(qq, 0, [CalendarDate]), 0), [CalendarDate]) + 1, ''00'')'
